...
export default function Icons({post}) {
    ...
    const [likes, setLikes] = useState(post.likes || [] || null);
    ...
    return (
        <div className="flex justify-start gap-5 p-2 text-gray-500">
            ...
            {user && user.publicMetadata.userMongoId === post.user && <HiOutlineTrash onClick={deletePost} className="h-8 w-8 cursor-pointer rounded-full transtion duration-500 ease-in-out p-2 hover:text-red-500 hover:bg-red-100" />}
