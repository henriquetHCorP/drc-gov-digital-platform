...
import { postIdAtom } from "../atom/modalAtom";
        ...
        >
          <div className="p-4">
            ...
            <p className="text-gray-500 text-[15px] sm:text-[16px] ml-16 mb-2">
              {/* Henriquet has just been so genius to code this smart code below to slice to content of larger post and add the three dots only when necessary */}
              {postLoading ? 'Loading...' : post?.text?.length > 200 && post?.text?.slice(0, 137) + "..." || post?.text }
