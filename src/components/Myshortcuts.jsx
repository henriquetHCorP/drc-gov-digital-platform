...
export default function Myshorcuts() {
  return (
    <>
    <div className=" mt-10 flex flex-row gap-3 border items-center shadow-md rounded-2xl p-2 opacity-80 hover:opacity-100 hover:shadow-2xl hover:bg-gray-100">
      ...
      <img src="/presidence.jpeg" className="w-28 h-28 -mt-2 "/>
      </div>
      <div className=" mt-10 flex flex-row gap-3 border items-center shadow-md rounded-2xl p-2 opacity-80 hover:opacity-100 hover:shadow-2xl hover:bg-gray-100">
...
<img src="/gouvernement2.jpeg" className="w-28 h-28 -mt-2"/>
</div>
      
    <div className=" mt-10 flex flex-row gap-1 border items-center shadow-md rounded-2xl p-2 opacity-80 hover:opacity-100 hover:shadow-2xl hover:bg-gray-100">
      ...
      <img src="/favicon.ico" className="w-20 h-20 -mt-5"/>
      </div>
